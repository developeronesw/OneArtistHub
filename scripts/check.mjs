...
if(!/function ThemeBuilder\(/.test(app)||!/defaultBuilder/.test(app)||!/function BuilderHome\(/.test(app)||!/\['builder','Theme Builder','palette'\]/.test(app)){console.error('FAIL Theme Builder restore');fail=true}else console.log('PASS Theme Builder restore');
...
if(!/square\/connect\/start/.test(connectWorker)||!/square\/oauth\/callback/.test(connectWorker)||!/square\/disconnect/.test(connectWorker)||!/square\/checkout/.test(connectWorker)||!/square\/order/.test(connectWorker)||!/SQUARE_CLIENT_ID/.test(connectWorker)||!/SQUARE_CLIENT_SECRET/.test(connectWorker)){console.error('FAIL Square Connect architecture');fail=true}else console.log('PASS Square Connect architecture');
if(!/squareConnect/.test(app)||!/Connect Square/.test(app)||!/Disconnect Square/.test(app)||!/admin\/square\/connect\/status/.test(api)){console.error('FAIL Square connection UI/API');fail=true}else console.log('PASS Square connection UI/API');
